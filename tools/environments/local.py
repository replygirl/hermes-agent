...
# Backward compat — process_registry.py imports this name.  It should honor
# terminal.shell just like LocalEnvironment foreground execution.
def _find_shell() -> str:
    return _find_configured_shell()[0]
